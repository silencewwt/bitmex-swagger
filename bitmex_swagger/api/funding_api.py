...
class FundingApi(object):
    ...
    def funding_get(self, **kwargs):  # noqa: E501
        """Get funding history.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.funding_get(async=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async'):
            return self.funding_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.funding_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def funding_get_with_http_info(self, **kwargs):  # noqa: E501
        """Get funding history.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.funding_get_with_http_info(async=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            response_type='list[Funding]',  # noqa: E501
