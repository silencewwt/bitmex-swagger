...
class SettlementApi(object):
    ...
    def settlement_get(self, **kwargs):  # noqa: E501
        ...
        >>> thread = api.settlement_get(async=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async'):
            return self.settlement_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.settlement_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def settlement_get_with_http_info(self, **kwargs):  # noqa: E501
        """Get settlement history.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.settlement_get_with_http_info(async=True)
        >>> result = thread.get()
