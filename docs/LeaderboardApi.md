...
api_instance = bitmex_swagger.LeaderboardApi()
...
# create an instance of the API class
api_instance = bitmex_swagger.LeaderboardApi(bitmex_swagger.ApiClient(configuration))
