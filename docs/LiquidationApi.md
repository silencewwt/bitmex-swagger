# bitmex_swagger.LiquidationApi

All URIs are relative to *https://localhost/api/v1*

Method | HTTP request | Description
------------- | ------------- | -------------
[**liquidation_get**](LiquidationApi.md#liquidation_get) | **GET** /liquidation | Get liquidation orders.
...
api_instance = bitmex_swagger.LiquidationApi()
