...
api_instance = bitmex_swagger.UserApi()
...
# create an instance of the API class
api_instance = bitmex_swagger.UserApi(bitmex_swagger.ApiClient(configuration))
...
# **user_update**
> User user_update(old_password=old_password, new_password=new_password, new_password_confirm=new_password_confirm, username=username, country=country, pgp_pub_key=pgp_pub_key)
...
try:
    # Update your password, name, and other attributes.
    api_response = api_instance.user_update(old_password=old_password, new_password=new_password, new_password_confirm=new_password_confirm, username=username, country=country, pgp_pub_key=pgp_pub_key)
    pprint(api_response)
except ApiException as e:
